...
//  Today
//
//  Created by Dok Yong COsta on 6/27/24.
//
...
extension ReminderViewController {
    ...
    func headerConfiguration(for cell: UICollectionViewListCell, at row: Row,with title: String) -> UIListContentConfiguration {
        var contentConfiguration = cell.defaultContentConfiguration()
